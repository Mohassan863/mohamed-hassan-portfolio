...
const Experience = () => {
  ...
  const experienceItems = [
    {
      role: "QC Trainee",
      company: " Aqua Pure, Riyadh, KSA",
      companyLink: "https://www.facebook.com/aquapuresaudia/", // <--- أضف رابط الشركة هنا
      duration: "Dec 2025 – Jan 2026",
      details: "•	 Conducted daily physicochemical analysis of water samples (pH, TDS, Conductivity) to ensure compliance with SASO and SFDA standards.•	Monitored production lines and maintained rigorous documentation of quality control checks.",
      certificateImage: "/certificates/Aqua_pure.jpeg", // <--- أضف مسار شهادة الخبرة هنا
    },{
      role: "Veterinary Pharmacy Sales Consultant",
      company: "Al-Awafi Veterinary Pharmacy Riyadh, Saudi Arabia",
      companyLink: "", // <--- أضف رابط الشركة هنا
      duration: "Sep 2025 – Nov 2025 ",
      details: "Technical Sales: Provided expert advice to walk-in customers regarding veterinary medications, vaccines, and nutritional supplements,Customer Consultation: Explained pharmaceutical compositions and dosage instructions based on biochemistry knowledge to ensure animal safety.Store Management: Managed indoor sales operations, handled transactions, and ensured the pharmacy shelf organization met professional standards.Inventory Control: Monitored expiration dates and storage temperatures (Cold Chain) for biological products according to SFDA guidelines.",
      certificateImage: "", // <--- أضف مسار شهادة الخبرة هنا
    },
    {
      role: "Chemist",
    ...
    {
      role: "Trainee Chemist – Clinical Labs |",
      company: " Magdi Yacoub Heart Foundation, Egypt ",
      companyLink: "https://www.myf-egypt.org/", // <--- أضف رابط الشركة هنا
      duration: "Sep 2022 ",
      details: "Trained in high-standard clinical biochemistry analysis for cardiac patients under strict Quality Control (QC) protocols. ",
      certificateImage: "", // <--- أضف مسار شهادة الخبرة هنا
    },
    {
      role: "Trainee",
